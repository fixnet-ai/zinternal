...
pub fn build(b: *std.Build) void {
    ...
    // Build standalone Android test executable
    ...
    android_test.linkSystemLibrary("android");
    ...
    // Build test_runner for Android with same config
    const android_runner_step = b.step("android-runner", "Build test_runner for Android with full config");
    ...
    android_runner.linkSystemLibrary("android");
    ...
    // Build test_runner for iOS Simulator with same config
    const ios_runner_step = b.step("ios-runner", "Build test_runner for iOS Simulator with full config");
